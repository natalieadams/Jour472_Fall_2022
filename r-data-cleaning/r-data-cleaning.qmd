...
#Answer 1
I would rename the state variables to Maryland. I would use the mutate and case_when functions to change "MD" and "md" to "Maryland" because once all of the state variables are standardized, summarize should work properly.
