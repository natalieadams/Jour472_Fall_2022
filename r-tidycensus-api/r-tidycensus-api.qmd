...
[Spotify](https://developer.spotify.com/documentation/web-api/) let's us ingest a bunch of information about what people are listening to. 
...
Alaska is the state with the highest male percentage of the population at more than 52%. Alaska's male population is 385,000 and its total population is 737,000, which is ranked 49th out of 50 states, Washington, D.C., and Puerto Rico. However, as a percentage, Alaska has the highest male population.
