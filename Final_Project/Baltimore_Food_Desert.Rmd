...
# Wells code that did work
supermarkets1 <- supermarkets %>% 
  st_as_sf(coords = c("x", "y"), crs = 4326)

# wells code that didn't work with error message

#Error in st_geos_binop("intersects", x, y, sparse = sparse, prepared = prepared, : 
#st_crs(x) == st_crs(y) is not TRUE
#stackoverflow in this error message: https://stackoverflow.com/questions/49141192/st-intersects-errors-for-st-crsx-st-crsy-is-not-true

supermarkets2 <-  neighborhoods %>% 
  st_join(supermarkets1)
