...
#leaflet race graph
The neighborhoods highlighted in yellow represent those with a majority white population. The neighborhoods in blue have a majority non-white population. 
...
The neighborhoods with a low income are highlighted in yellow and neighborhoods with high incomes are highlighted in blue.
```{r}
pal <- colorFactor(
  palette = c('red', 'darkgreen', 'black'),
  domain = baltimore_stores$store_type
